...
from emg2qwerty.customs.data import get_max_spec_size # CHANGE


log = logging.getLogger(__name__)

os.environ["HYDRA_FULL_ERROR"] = "1" # CHANGE

@hydra.main(version_base=None, config_path="../../config", config_name="whisper") # CHANGE
def main(config: DictConfig):
    ...
    module = instantiate(
        config.module,
        max_T=get_max_spec_size(config)[0], # CHANGE
